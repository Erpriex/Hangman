...
class HelpManager:
    ...
    def openWindow(self):
        ...
        label_Diff1 = Label(self.window, text="• La difficulté facile lorsqu'elle est choisi "
                                "prend un mot avec 4 lettres ou moins. ", font=("Courrier", 15), bg='midnightblue',
                                fg='white')
        label_Diff1.place(relx=0.5, rely=0.2, anchor=CENTER)

        label_Diff2 = Label(self.window, text="• La difficulté moyenne lorsqu'elle est choisi "
        ...
        label_Diff3 = Label(self.window, text="• La difficulté difficile lorsqu'elle est choisi "
        ...
        label_Score2 = Label(self.window, text="• Lorsque le joueur trouve un mot il va gagné des points "
                                               "en fonction de la difficulté choisi :",
                             font=("Courrier", 15), bg='midnightblue', fg='white')
        label_Score2.place(relx=0.5, rely=0.5, anchor=CENTER)

        label_Score3 = Label(self.window, text="- Facile : 5 points     - Moyen : 10 points      "
                                               "- Difficile : 20 points",
                             font=("Courrier", 15), bg='midnightblue', fg='white')
        label_Score3.place(relx=0.5, rely=0.54, anchor=CENTER)

        label_Score4 = Label(self.window, text="• Le nombre d'essai restants a la fin de la partie vont s'ajouter au "
                                               "score du joueur.",
                             font=("Courrier", 15), bg='midnightblue', fg='white')
